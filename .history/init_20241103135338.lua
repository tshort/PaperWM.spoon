...
---@return nil
local function stashWindow(windowid)
    local idx = idx_table[windowid]
    local w = window_list[unpack(idx)]
...
---@param windowid window to move
---@return nil
local function restoreWindow(windowid)
    local idx = idx_table[windowid]
    local w = window_list[unpack(idx)]
    local frame = screen:frame()
